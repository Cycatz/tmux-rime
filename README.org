...
After you finish configuring the kernel, you'll need to start a another console/terminal on your computer with the newly-built kernel to run the rime IME server. 
#+begin_src sh
