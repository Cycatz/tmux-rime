...
rime_wrapper_commit_composition = _lib.rime_wrapper_commit_composition
rime_wrapper_commit_composition.argtypes = [c_void_p]
rime_wrapper_commit_composition.restype = c_int
